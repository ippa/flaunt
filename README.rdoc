...
* Just put <hr> in your presentation and the content between them will become separate slides each one filling the whole browser.
...
== INSTALL AS A MOUNTABLE SINATRA APP
